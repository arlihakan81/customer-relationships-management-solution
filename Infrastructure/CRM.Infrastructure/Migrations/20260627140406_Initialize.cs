    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealLineItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DealLineItems_Deals_DealId",
                        column: x => x.DealId,
                        principalTable: "Deals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DealLineItems_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DealLineItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DealLineItems_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DealLineItems_Users_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DealLineItems_Users_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 27, 17, 4, 4, 858, DateTimeKind.Local).AddTicks(6487), null, null, "Super Admin" },
                    { 2, new DateTime(2026, 6, 27, 17, 4, 4, 858, DateTimeKind.Local).AddTicks(6502), null, null, "Admin" },
                    { 3, new DateTime(2026, 6, 27, 17, 4, 4, 858, DateTimeKind.Local).AddTicks(6504), null, null, "User" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealLineItems_CreatedById",
                table: "DealLineItems",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_DealLineItems_DealId",
                table: "DealLineItems",
                column: "DealId");

            migrationBuilder.CreateIndex(
                name: "IX_DealLineItems_DeletedById",
                table: "DealLineItems",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_DealLineItems_ModifiedById",
                table: "DealLineItems",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_DealLineItems_OrganizationId",
                table: "DealLineItems",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_DealLineItems_ProductId",
                table: "DealLineItems",
                column: "ProductId");
